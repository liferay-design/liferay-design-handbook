...
goog.loadModule(function (exports) {
  ...
  function $render(opt_data, opt_ignored, opt_ijData) {
    ...
    var param334 = function param334() {
      ...
      $templateAlias3({ action: '/docs/search.html', dataURL: (($$temp = opt_data.site.basePath) == null ? '' : $$temp) + '/site.json', path: '/docs/', placeholder: 'Type your search terms here' }, null, opt_ijData);
      ie_close('div');
      ie_close('div');
      ie_close('div');
      ie_close('div');
    };
    $templateAlias1(soy.$$assignDefaults({ elementClasses: 'docs', content: param334 }, opt_data), null, opt_ijData);
  }
